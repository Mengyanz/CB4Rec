...
train_dir="train_valid" # "train_valid"
test_dir="train_valid" # "test"
dataset="large"
...
npratio=4
filename_pat="high_part_user_behaviors.tsv" # "behaviors_*.tsv"
...
then
    ...
    --load_ckpt_name ${load_ckpt_name} --filename_pat ${filename_pat}
fi