...
def parse_args():
    ...
    parser.add_argument("--num_selected_users", type=int, default=10, help='number of randomly selected users from val set') # 1000
    parser.add_argument("--cb_train_ratio", type=float, default=0.2)
    parser.add_argument("--sim_npratio", type=int, default=4)
    parser.add_argument("--sim_val_batch_size", type=int, default=1024) # 1024
    ...
    parser.add_argument("--topic_update_period", type=int, default=1, help = 'Update period for CB topic model') # 100
