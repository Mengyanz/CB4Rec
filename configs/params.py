...
def parse_args():
    ...
    parser.add_argument("--result_path", type=str, default='CB4Rec/results/', help = 'CB simulation results')

    # Preprocessing 
    parser.add_argument("--dataset",type=str,default='large') # movielens
    ...
    parser.add_argument("--sim_path", type=str, default='./pretrained_models/sim_emp_ips_nrms_normalized_r14_ep5', help='nrms: simulator_pretrained_models/sim_nrms_bce_r14_ep6_thres038414; ips: ./pretrained_models/sim_emp_ips_nrms_normalized_r14_ep5') 
    parser.add_argument("--sim_threshold", type=float, default=0.38414)
    parser.add_argument("--ips_path", type=str, default="CB4Rec/runs/prop_pn=2-8_20220222_163423/model_best_4")
